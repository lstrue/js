//in this version I want to draw the whole thing on canvas
//my idea is that I need to draw a seperate canvas with lines in another file and try to combine
//otherwise I may get confused with this many files
"use strict";
(function(){//use module, don't need to put var in function except recursion
    ...
    //print outSource
    var getSource = function(square){ //this square should not be passed here since it's on the top
        var source = "<pre><h1>";
