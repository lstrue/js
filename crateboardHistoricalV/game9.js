...
//this is a not working version, but in this one I solved how to move "5"

//
////In this version I will refactor a little bit and put start and target in function
//I actually add move up down right too early - I should just work on left now
//And I shouldn't refactor at this point

//I should just try to get other requirements done
"use strict";
(function(){
    ...
    var initialArr = function(){
        ...
        squareSize = 8;//for test, need to change back later - delete
        ...
        for(i=0; i<squareSize; i++){
            ...
            for(j=0; j<squareSize; j++){
                if(Math.random()<0.2){
                    ...
                    square[i][j] = 0;//for test, need to change back later
//                    square[i][j] = 2;
                }else if(Math.random()<0.4){
                    square[i][j] = 0;//for test, need to change back later
//                    square[i][j] = 3;
...
//                    alert("sumInFront: "+sumInFront);
        ...
        if(X - 1 >= 0){
            if(sumInFront <= 3){
                if(square[X - 1][Y] === 0){
                    ...
                    return;
                }else if(square[X][Y - 1] > 0 && square[X][Y - 1] < 4 ){
                    numInFront++;
    ...
    //when move down to the border there is an error, solve this later
