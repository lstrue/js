...
//                    alert("sumInFront: "+sumInFront);
    ...
    var showGoalPosition = function(goalY){
        var goalPosition = "<h3><p>Push cat box to the "+ (goalY + 1) + "th spot at the bottom.</p> \n\
                        <p>Use arrow key to move and use Enter key to explode the box in the front which costs 100 moves.</p>\n\
                        <p>Try to minimize moves in total. </p></h3>";
    ...
    var direction = function(directionNum){
        switch(directionNum){
        case 1:
            document.getElementById("direction").innerHTML='<img src="./images/left.jpg" alt="Left" width="40" height="40" />';
            break;
        case 2:
            document.getElementById("direction").innerHTML='<img src="./images/up.jpg" alt="Up" width="40" height="40" />';
            break;
        case 3:
            document.getElementById("direction").innerHTML='<img src="./images/right.jpg" alt="Right" width="40" height="40" />';
            break;
        case 4:
            document.getElementById("direction").innerHTML='<img src="./images/down.jpg" alt="Down"  width="40" height="40" />';
            break;
        default:
        }
    }
